...
#ifndef ASPS_MODBUS_PDU_SEQUENCE_SEQUENCE_HPP
#define ASPS_MODBUS_PDU_SEQUENCE_SEQUENCE_HPP
...
{
public:
  active_sequence(const request::pointer_type& req);
  virtual ~active_sequence() {}

public:
  const buffer_type& send_request() override;
  bool receive_response(const buffer_type& buffer) override;
...
#endif // ASPS_MODBUS_PDU_SEQUENCE_SEQUENCE_HPP
